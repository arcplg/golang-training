                                ...
                                <form>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label text-dark fs-3" for="flexCheckChecked"> Remeber this Device </label>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <a class="text-primary fw-medium ms-2" href="#">Create an account</a>
                                    </div>
                                </form>
                            </div>
                        </div>
